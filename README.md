...
Once Cheched out you can add the Microservices you want to work on by simply checking them out to the src -> Mcroservices directory found within this solution.
...
With the directory structure looking ike this:
...
Each microservice still has its own .sln file and can be worked on indidually. They are however setup by default to sit within the above structure as the generic library dependencies are pulled in from the parent solution.
